...
class sc(Scene):
    ...
    def construct(self):
        ...
        code = Code("assets/code/mainv3p2.cpp", line_spacing=0.8, font_size=12, line_no_from=23).next_to(rec, DOWN)
        to_load = [code[2][5:7], code[2][14:16]]
        ...
        for i, (chunk, w_time) in enumerate(zip(to_load, [4, 4])):
            chunk.set_opacity(1)
